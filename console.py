...
class HBNBCommand(cmd.Cmd):
    ...
    def default(self, arg):
        """Default behavior for cmd module when input is unknown"""
        argdict = {
            "all": self.do_all,
            "show": self.do_show,
    ...
    def do_all(self, arg):
        ...
        Displays a string representation of all instances of a given class.
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        Updates a class instance of a id by adding or updating
